                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-3">
                                        {{--<img class="card-img-top" src="{{ asset('images/instruction/ck-account-apps.png') }}" alt="Карточка Приложения в маркетплейс InSales">--}}
                                        ...
                                        <img class="card-img-bottom" src="{{ asset('images/instruction/ck-account-apps.png') }}" alt="Личный кабинет пользователя сервиса CloudPayments">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-3">
                                        ...
                                        <img class="card-img-bottom" src="{{ asset('images/instruction/cp-api.png') }}" alt="Личный кабинет пользователя сервиса CloudPayments">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-3">
                                        ...
                                        <img class="card-img-bottom" src="{{ asset('images/instruction/ck-initial-master.png') }}" alt="Раздел с установленными приложениями Пользователя InSales">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-3">
                                        ...
                                        <img class="card-img-bottom" src="{{ asset('images/instruction/ck-final-state.png') }}" alt="Главное меню приложения">
                                    </div>
                                </div>
                            </div>
